...
import { Button, Select, FieldError, Input, Label, ListBox, Modal, Surface, TextArea, TextField, departureDate, category } from "@heroui/react";
import { BiEdit } from "react-icons/bi";

export function EditModal({ destination }) {
    const { _id, imageUrl, price, destinationName, description, duration, country, departureDate, category } = destination;
    ...
    return (
        <Modal>
                <Button className={'rounded-none '} variant='outline'><BiEdit /> Edit</Button>
            <Modal.Backdrop>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        ...
                                        <div className="md:col-span-2">
                                            <TextField defaultValue={imageUrl} name="imageUrl" isRequired>
                                                ...
                                                <Input type="url" placeholder="https://example.com/bali-paradise.jpg"
